...
public class BookshelfController {
	...
	/**
	 * Attempt to load the model object tree from a file.
	 * This method instantiates the member variable with either
	 * a new Bookshelf or a existing one from a file.
	 * 
